...
function showContent(result) {
	...
	innerCode= '<ul class="mui-table-view"><li class="mui-table-view-cell"><img class="mui-pull-left" src="' + result.personlogo + '" />' +
	...
	if(numOfPhotos != 0) {
		if(numOfPhotos == 1) {
			innerCode += '<div class="photos"> <img class="photo" style="width:100%;" src="' + result.imgurl[0].imgurl + '" data-preview-src="" data-preview-group="' + 1 + '"/> </div>';

		} else if(numOfPhotos == 2) {
			innerCode += '<div class="photos"><img class="photo" style="width:40%;" src="' + result.imgurl[0].imgurl + '" data-preview-src="" data-preview-group="' + 1 + '"/>' +
			...
			for(var j = 0; j < numOfPhotos; j++) {
				innerCode += '<img class="photo"  src="' + result.imgurl[j].imgurl + '" data-preview-src="" data-preview-group="' + 1 + '"/>';
			}
			innerCode += '</div>';
		}
	}
	 ...
	 * 回复部分取消
	 */
	//innerCode += ' <ul class="mui-table-view reply"><li class="mui-table-view-cell"><img class="mui-icon" src="../../images/Assets.xcassets/comment.imageset/comment@2x.png" /><span>暂无回复</span></li></ul>';
