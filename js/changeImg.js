var url = 'http://121.42.29.124/workoa/index.php?s=/Api/Store/personLogo_image_down/';
...
function createUploader() {
	task = plus.uploader.createUpload(url, {
		...
		if(status == 200) {
			...
			var page = plus.webview.getWebviewById('person.html');
...
function showPhotos() {
	var table = document.getElementById('headImg');
	 table.src=photos[0].path;
	 upload()
}